...
public interface Buffer {
	...
	/**
	 * delete and return the character to the right of the cursor given
	 * "abc|def", deleteRight() => "abc|ef"
	 */
	public char deleteRight();

	/**
	 * delete and return the character to the left of the cursor given
	 * "abc|def", deleteLeft() => "ab|def"
	 */
